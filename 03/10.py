...
tiempo_tot_h = tiempo_segundos//3600
tiempo_tot_m = (tiempo_segundos%3600)//60
tiempo_tot_s = (tiempo_segundos%3600)%60
print(f'Tiempo (hh:mm:ss): {tiempo_tot_h}:{tiempo_tot_m}:{tiempo_tot_s}')

tiempo_max = max(tiempo_n, tiempo_c, tiempo_p)
tiempo_min = min(tiempo_n, tiempo_c, tiempo_p)
print(f'Tiempo maximo: {tiempo_max}s\nTiempo minimo: {tiempo_min}s')
